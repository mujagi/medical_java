...
public class C0620_08 {
	...
	int num = 0; //인스턴스변수 - 객체선언선후 참조변수명.변수명으로 사용
	static int n = 0; //클래스변수 객체선언 x 클래스명.변수명으로 사용
		...
		while(true) {
			...
			case 2 :
				...
				for(int i=0;i<s_count;i++) {
					...
					System.out.printf("%d\t",sc[i].kor); //국어,영어,수학,합계
					System.out.printf("%d\t",sc[i].eng); //국어,영어,수학,합계
					System.out.printf("%d\t",sc[i].math); //국어,영어,수학,합계
					System.out.printf("%d\t",sc[i].total); //국어,영어,수학,합계
